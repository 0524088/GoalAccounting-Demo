...
const Preferences = registerPlugin("Preferences", {
  web: () => __vitePreload(() => import("./web.5f693b5b.js"), true ? [] : void 0).then((m) => new m.PreferencesWeb())
});
...
const Filesystem = registerPlugin("Filesystem", {
  web: () => __vitePreload(() => import("./web.39a471ba.js"), true ? [] : void 0).then((m) => new m.FilesystemWeb())
});
const App = registerPlugin("App", {
  web: () => __vitePreload(() => import("./web.38f585fb.js"), true ? [] : void 0).then((m) => new m.AppWeb())
});
const custom$1 = {
  BarAlertRange: {
    middle: 70,
...
registerPlugin("Share", {
  web: () => __vitePreload(() => import("./web.3dbd6f72.js"), true ? [] : void 0).then((m) => new m.ShareWeb())
});
async function saveFileToLocal() {
  try {
    const all_data = {
      goal: await storage_getItem("Data"),
      accounting: await storage_getItem("Accounting")
    };
    const jsonString = JSON.stringify(all_data);
    await Filesystem.writeFile({
      path: "goal_accounting.json",
      data: jsonString,
    ...
    switch ((_a = target.dataset) == null ? void 0 : _a.action) {
      case "copy":
        ...
        async function copyPreviousGoal() {
          ...
          console.log(AccountingValue$1[thisDate]);
          for (let goal of DataValue$1[thisDate]["items"]) {
            if (goal.name == "\u5176\u4ED6\u82B1\u8CBB")
              continue;
            AccountingValue$1[thisDate][goal.name] = [];
          }
  ...
  async function removeItem() {
    await showAlert({
      ...
      if (confirm2.isConfirmed) {
        ...
        DataValue$1 = await Data$1.set(DataValue$1);
...
registerPlugin("CapacitorSQLite", {
  web: () => __vitePreload(() => import("./web.fa70a3b5.js"), true ? [] : void 0).then((m) => new m.CapacitorSQLiteWeb()),
