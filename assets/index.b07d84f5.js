...
const Preferences = registerPlugin("Preferences", {
  web: () => __vitePreload(() => import("./web.9c45eca7.js"), true ? [] : void 0).then((m) => new m.PreferencesWeb())
});
...
registerPlugin("Filesystem", {
  web: () => __vitePreload(() => import("./web.160a2f3f.js"), true ? [] : void 0).then((m) => new m.FilesystemWeb())
});
const App = registerPlugin("App", {
  web: () => __vitePreload(() => import("./web.b18fe3cb.js"), true ? [] : void 0).then((m) => new m.AppWeb())
});
const custom$1 = {
  BarAlertRange: {
    middle: 70,
...
registerPlugin("CapacitorSQLite", {
  web: () => __vitePreload(() => import("./web.c37d3146.js"), true ? [] : void 0).then((m) => new m.CapacitorSQLiteWeb()),
